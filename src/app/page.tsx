...
export const metadata: Metadata = {
  title: "EMDR & IFS Therapy in Golden, CO | Other Ways Therapy",
  description:
    "Virtual EMDR, IFS, and ketamine integration helping Golden, CO clients process trauma with nervous system-safe care.",
