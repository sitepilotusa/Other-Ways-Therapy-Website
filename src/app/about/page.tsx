    ...
    <main className="flex flex-col !bg-white">
      ...
      <section className="w-full !bg-white section-padding">
        <div className="section-container">
          <div className="mx-auto max-w-4xl card-rounded-sm bg-[#AFA691] p-6 md:p-10 lg:p-12">
